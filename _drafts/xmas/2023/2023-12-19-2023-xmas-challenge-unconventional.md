...
{% include image.html id="santa" style="max-width: 250px; padding: 10px; float: left" %} It's July in Toyland, Santa visits to see how his order of 600 1" toy soldiers is going...only to find that Laurel and Hardy took the order and the Toy Master has produced 100 of them at 6' tall! On top of that, Silus Barnaby holds an overdue mortgage on the Old Lady Who lived in a Shoe, but will release the mortgage if she agrees to allow him to marry Little Bo Beep. 

{% include image.html id="boo-peep" style="max-width: 350px" %}{% include image.html id="shoe" style="max-width: 350px" %}
...
1. peewee boomerang scenes (and it's payoff at the end),
